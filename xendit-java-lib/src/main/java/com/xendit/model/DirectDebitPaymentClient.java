...
public class DirectDebitPaymentClient {
  ...
  public DirectDebitPayment validateOTP(String directDebitPaymentId, Map<String, Object> params)
      throws XenditException {
    return validateOTPRequest(directDebitPaymentId, new HashMap<>(), params);
  }
  ...
  public DirectDebitPayment getDirectDebitPaymentStatusById(String directDebitPaymentId)
    ...
    String url =
        String.format(
            "%s%s%s%s", Xendit.Opt.getXenditURL(), "/direct_debits/", directDebitPaymentId, "/");
  ...
  public DirectDebitPayment[] getDirectDebitPaymentStatusByReferenceId(String referenceId)
    ...
    String url =
        String.format(
            "%s%s%s", Xendit.Opt.getXenditURL(), "/direct_debits?reference_id=", referenceId);
    return this.requestClient.request(
        RequestResource.Method.GET, url, null, opt.getApiKey(), DirectDebitPayment[].class);
  }
  ...
  public DirectDebitPayment validateOTPRequest(
    ...
    String url =
        String.format(
            "%s%s%s%s",
            Xendit.Opt.getXenditURL(), "/direct_debits/", directDebitPaymentId, "/validate_otp/");
  ...
  public PaymentMethod createPaymentMethod(Map<String, String> headers, Map<String, Object> params)
      throws XenditException {
  ...
  public PaymentMethod[] getPaymentMethodsByCustomerId(String customerId) throws XenditException {
    String url =
        String.format(
            "%s%s%s", Xendit.Opt.getXenditURL(), "/payment_methods?customer_id=", customerId);
    return this.requestClient.request(
  ...
  public InitializedLinkedAccount initializeLinkedAccountTokenization(Map<String, Object> params)
      throws XenditException {
    return initializeLinkedAccountTokenizationRequest(new HashMap<>(), params);
  }
  ...
  public ValidatedLinkedAccount validateOTPRequestWithToken(
    ...
    String url =
        String.format(
            "%s%s%s%s",
            Xendit.Opt.getXenditURL(), "/linked_account_tokens/", tokenId, "/validate_otp");
  ...
  public AccessibleLinkedAccount[] retrieveAccessibleLinkedAccounts(String linkedAccountTokenId)
      throws XenditException {
    String url =
        String.format(
            "%s%s%s%s",
  ...
  public UnbindedLinkedAccount unbindLinkedAccountToken(String linkedAccountTokenId)
    ...
    String url =
        String.format(
            "%s%s%s", Xendit.Opt.getXenditURL(), "/linked_account_tokens/", linkedAccountTokenId);
    return this.requestClient.request(
