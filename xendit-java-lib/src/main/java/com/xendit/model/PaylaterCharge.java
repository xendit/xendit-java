...
public class PaylaterCharge {
   ...
   * @param checoutMethod Checkout method end-customer will apply.
   * @param successRedirectUrl where the customer is redirected after completing transaction(must be HTTP or HTTPS).
   ...
   * @throws XenditException
   */
  public static PaylaterCharge createPaylaterCharge(Map<String, Object> params)
      throws XenditException {
    return createPaylaterChargeRequest(new HashMap<>(), params);
  }
   ...
   * @throws XenditException
   */
  public static PaylaterCharge createPaylaterCharge(
