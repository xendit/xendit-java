...
public class PaylaterRefund extends AbstractResponseHeaders {
   ...
   * Create a refund
   *
   * @param chargeId Charge ID of the paylater that will be refunded
   ...
   * @param refundId id of the refund paylater charge
   * @return PaylaterRefund
   * @throws XenditException XenditException
   */
  public static PaylaterRefund getPaylaterRefundStatus(String chargeId, String refundId)
      throws XenditException {
    PaylaterClient client = getClient();
