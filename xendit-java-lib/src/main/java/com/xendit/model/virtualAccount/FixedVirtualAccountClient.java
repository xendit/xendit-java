package com.xendit.model.virtualAccount;
...
public class FixedVirtualAccountClient {
  ...
  public FixedVirtualAccount createClosed(Map<String, String> headers, Map<String, Object> params)
  ...
  public FixedVirtualAccount createOpen(Map<String, String> headers, Map<String, Object> params)
      throws XenditException {
  ...
  public FixedVirtualAccount getFixedVA(Map<String, String> headers, String id)
      throws XenditException {
    String url =
        String.format("%s%s%s", Xendit.Opt.getXenditURL(), "/callback_virtual_accounts/", id);
    return this.requestClient.request(
  ...
  public FixedVirtualAccountPayment getPayment(String paymentId) throws XenditException {
    String url =
        String.format(
            "%s%s%s",
            Xendit.Opt.getXenditURL(), "/callback_virtual_account_payments/payment_id=", paymentId);
    return this.requestClient.request(
