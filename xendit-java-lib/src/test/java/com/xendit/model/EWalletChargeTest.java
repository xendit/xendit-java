...
public class EWalletChargeTest {
  private static String URL = String.format("%s%s", Xendit.getUrl(), "/ewallets/charges");
  ...
  public void createEWalletCharge_Success_IfParamsIsValid() throws XenditException {
    ...
    EWalletCharge eWalletCharge = EWalletCharge.createEWalletCharge(PARAMS);
  ...
  public void createEWalletCharge_Success_WithHeaderProvided() throws XenditException {
    ...
    EWalletCharge eWalletCharge = EWalletCharge.createEWalletCharge(HEADERS, PARAMS);
  ...
  public void createEWalletCharge_ThrowsException_IfParamsIsInvalid() throws XenditException {
    ...
    when(Xendit.requestClient.request(
            RequestResource.Method.POST, URL, new HashMap<>(), PARAMS, EWalletCharge.class))
        .thenThrow(new XenditException("E-Wallet charge currency is invalid"));

    EWalletCharge.createEWalletCharge(PARAMS);
  }
  ...
  public void getEWalletChargeStatus_Success_IfIdIsAvailable() throws XenditException {
    ...
    when(Xendit.requestClient.request(RequestResource.Method.GET, url, null, EWalletCharge.class))
        .thenReturn(VALID_EWALLET_CHARGE);

    EWalletCharge eWalletCharge = EWalletCharge.getEWalletChargeStatus(CHARGE_ID);
  ...
  public void getEWalletChargeStatus_ThrowsException_IfIdIsNotAvailable() throws XenditException {
    ...
    EWalletCharge.getEWalletChargeStatus(NOT_AVAILABLE_ID);
  }
}
