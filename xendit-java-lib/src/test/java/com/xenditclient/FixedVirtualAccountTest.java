...
public class FixedVirtualAccountTest {
    ...
    private static String URL = String.format("%s%s", Xendit.Opt.getXenditURL(), "/callback_virtual_accounts");
    ...
    public void createClosed_ThrowsException_IfParamsAreInvalid() throws XenditException {
        ...
        when(fixedVirtualAccountClient.createClosed(PARAMS)).thenThrow(new XenditException("Maximum amount is 50000000000"));
    ...
    public void createOpen_ThrowsException_IfParamsAreInvalid() throws XenditException {
        ...
        when(fixedVirtualAccountClient.createOpen(PARAMS)).thenThrow(new XenditException("That bank code is not currently supported"));
    ...
    public void getFixedVA_Success_IfIdIsAvailable() throws XenditException {
        ...
        when(this.requestClient.request(
                RequestResource.Method.GET, url, new HashMap<>(), null, opt.getApiKey(), FixedVirtualAccount.class))
                .thenReturn(VALID_ACCOUNT);
    ...
    public void getFixedVA_ThrowsException_IfIdIsAvailable() throws XenditException {
        ...
        when(fixedVirtualAccountClient.getFixedVA("fake_id")).thenThrow(new XenditException("Callback virtual account not found"));
    ...
    public void update_ThrowsException_IfIdIsNotAvailable() throws XenditException {
        ...
        when(fixedVirtualAccountClient.update("fake_id", params)).thenThrow(new XenditException("Could not find callback virtual account"));
    ...
    public void getPayment_Success_IfIdIsAvailable() throws XenditException {
        ...
        String url =
                String.format(
                        "%s%s", Xendit.Opt.getXenditURL(), "/callback_virtual_account_payments/payment_id=test_id");
