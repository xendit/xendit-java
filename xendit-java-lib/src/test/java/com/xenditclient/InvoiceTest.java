...
public class InvoiceTest {
    private static final String URL_V2 = String.format("%s%s", com.xendit.Xendit.getUrl(), "/v2/invoices");
    private static final String URL_V1 = String.format("%s%s", com.xendit.Xendit.getUrl(), "/invoices");
    ...
    public void create_Success_IfParamsAreValid() throws XenditException {
        when(this.requestClient.request(RequestResource.Method.POST, URL_V2, PARAMS, opt.getApiKey(), Invoice.class))
                .thenReturn(VALID_INVOICE);
        when(invoiceClient.create(TEST_EXTERNAL_ID, TEST_AMOUNT, TEST_EMAIL, TEST_DESC)).thenReturn(VALID_INVOICE);
    ...
    public void create_ThrowsException_IfAmountIsLessThanMinimum() throws XenditException {
        ...
        when(invoiceClient.create(TEST_EXTERNAL_ID, TEST_AMOUNT, TEST_EMAIL, TEST_DESC)).thenThrow(XenditException.class);
    ...
    public void create_ThrowsException_IfInvalidParams() throws XenditException {
        ...
        when(this.requestClient.request(
                RequestResource.Method.POST, URL_V2, new HashMap<>(), params, opt.getApiKey(), Invoice.class))
                .thenThrow(XenditException.class);
    ...
    public void expire_Success_IfIdIsAvailable() throws XenditException {
        ...
        when(this.requestClient.request(
                RequestResource.Method.POST, url, new HashMap<>(), null, opt.getApiKey(), Invoice.class))
                .thenReturn(VALID_INVOICE);
