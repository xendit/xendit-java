...
public class PaylaterRefundTest {
  ...
  private static PaylaterRefund VALID_PAYLATER_REFUND = PaylaterRefund.builder().build();
  ...
  public void createPaylaterRefund_Success_IfParamsIsValid() throws XenditException {
    ...
    when(paylaterClient.createPaylaterRefund(CHARGE_ID, AMOUNT, REASON))
        .thenReturn(VALID_PAYLATER_REFUND);
  ...
  @Test
  public void createRefundCharge_Success_WithHeaderProvided() throws XenditException {
    String url = String.format("%s%s%s", URL, "/", CHARGE_ID, "/refunds");
    PARAMS.put("amount", AMOUNT);
    PARAMS.put("reason", REASON);
    ...
    PaylaterRefund paylaterRefund =
        paylaterClient.createPaylaterRefund(HEADERS, CHARGE_ID, AMOUNT, REASON);

    assertEquals(paylaterRefund, VALID_PAYLATER_REFUND);
  }

  @Test(expected = XenditException.class)
  public void createPaylaterRefund_ThrowsException_IfParamsIsInvalid() throws XenditException {
  ...
  public void getPaylaterRefundStatus_Success_IfIdIsAvailable() throws XenditException {
    ...
    when(this.requestClient.request(
        ...
        .thenReturn(VALID_PAYLATER_REFUND);
    when(paylaterClient.getPaylaterRefundStatus(CHARGE_ID, REFUND_ID))
        .thenReturn(VALID_PAYLATER_REFUND);
  ...
  @Test(expected = XenditException.class)
  public void getPaylaterRefundStatus_ThrowsException_IfIdIsNotAvailable() throws XenditException {
