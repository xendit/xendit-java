...
public class ExampleCreateDirectDebitPayment {
	private static void createDirectDebitPayment(XenditClient xenditClient) {
		try {
			...
			DirectDebitPayment directDebitPayment = xenditClient.directDebitPayment.createDirectDebitPayment(
					referenceId,
					paymentMethodId,
					currency,
					amount,
	...
	private static void createDirectDebitPayment_withAllParametersAsHashmap(XenditClient xenditClient) {
		try {
			DirectDebitBasketItem basketItem =  DirectDebitBasketItem.builder()
					.referenceId("basket-product-ref-id")
					.name("product-name")
